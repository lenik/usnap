...
Declare Function FIBB_IA Lib "FastImg" (ByVal newA As Long) As Boolean
...
Declare Function BitBltGradient Lib "FastImg" Alias "FIBBEG" (ByVal hDestDC As Long, ByVal destx As Long, ByVal desty As Long, ByVal width As Long, ByVal height As Long, ByVal color1 As Long, ByVal color2 As Long, Optional ByVal bVertical As Boolean = True) As Boolean
