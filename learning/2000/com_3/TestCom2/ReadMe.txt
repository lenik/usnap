========================================================================
		ActiveX Control DLL : TESTCOM2
========================================================================

ControlWizard has created this project for your TESTCOM2 ActiveX Control
...
that make up your TESTCOM2 ActiveX Control DLL.
...
TestCom2Ctl.h
	This file contains the declaration of the CTestCom2Ctrl C++ class.

TestCom2Ctl.cpp
	This file contains the implementation of the CTestCom2Ctrl C++ class.

TestCom2Ppg.h
	This file contains the declaration of the CTestCom2PropPage C++ class.

TestCom2Ppg.cpp
	This file contains the implementation of the CTestCom2PropPage C++ class.

TestCom2Ctl.bmp
	This file contains a bitmap that a container will use to represent the
	CTestCom2Ctrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file TestCom2.rc.
