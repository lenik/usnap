========================================================================
		ActiveX Control DLL : TESTCOM
========================================================================

ControlWizard has created this project for your TESTCOM ActiveX Control
...
that make up your TESTCOM ActiveX Control DLL.
...
TestComCtl.h
	This file contains the declaration of the CTestComCtrl C++ class.

TestComCtl.cpp
	This file contains the implementation of the CTestComCtrl C++ class.

TestComPpg.h
	This file contains the declaration of the CTestComPropPage C++ class.

TestComPpg.cpp
	This file contains the implementation of the CTestComPropPage C++ class.

TestComCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CTestComCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file TestCom.rc.
