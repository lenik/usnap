...
#if !defined(AFX_STDAFX_H__8664C08B_EEA3_48CF_BC18_55D6649C6EDD__INCLUDED_)
#define AFX_STDAFX_H__8664C08B_EEA3_48CF_BC18_55D6649C6EDD__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in addin1.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__8664C08B_EEA3_48CF_BC18_55D6649C6EDD__INCLUDED)
