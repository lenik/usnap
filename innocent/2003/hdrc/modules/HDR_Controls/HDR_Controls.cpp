...
USEFORM("SmallHexEditImpl1.cpp", SmallHexEdit); /* TActiveForm: File Type */ /* SmallHexEdit: CoClass */
USEFORM("SHE_About1.cpp", SmallHexEditAbout);
USEFORM("HDPositionImpl1.cpp", HDPosition); /* TActiveForm: File Type */ /* HDPosition: CoClass */
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_SmallHexEdit, TSmallHexEditImpl)
  OBJECT_ENTRY(CLSID_HDPosition, THDPositionImpl)
END_OBJECT_MAP()
