========================================================================
		ActiveX Control DLL : HEXEDITCTL
========================================================================

ControlWizard has created this project for your HEXEDITCTL ActiveX Control
...
that make up your HEXEDITCTL ActiveX Control DLL.
...
HexEditCtlCtl.h
	This file contains the declaration of the CHexEditCtlCtrl C++ class.

HexEditCtlCtl.cpp
	This file contains the implementation of the CHexEditCtlCtrl C++ class.

HexEditCtlPpg.h
	This file contains the declaration of the CHexEditCtlPropPage C++ class.

HexEditCtlPpg.cpp
	This file contains the implementation of the CHexEditCtlPropPage C++ class.

HexEditCtlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHexEditCtlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HexEditCtl.rc.
